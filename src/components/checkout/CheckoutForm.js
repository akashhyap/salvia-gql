...
import { getFormattedCart,createCheckoutData } from '@/lib/util';
import OrderSuccess from "./OrderSuccess";
import GET_CART from '@/lib/query/get-cart';
import CHECKOUT_MUTATION from '@/lib/mutation/checkout';
import Address from "./Address";
import { handleBillingDifferentThanShipping } from '@/lib/utils/checkout';
import { handleCreateAccount } from '@/lib/utils/checkout';
import { handleStripeCheckout } from '@/lib/utils/checkout';
import { setStatesForCountry } from '@/lib/utils/checkout';
// import {
